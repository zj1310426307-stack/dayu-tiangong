...
The protection was configured before PR #10 was merged. The four D2 contexts were added
only after their exact GitHub Actions names completed successfully in hosted run
`33113201345`; all four original D1 checks remain required. The full configuration was
then read back: strict update, PR, conversation resolution, administrator enforcement,
zero approvals, blocked force push, and blocked deletion all remain active.
