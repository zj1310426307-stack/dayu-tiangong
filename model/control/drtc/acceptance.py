...
CONTROLLED_RUNTIME_ACCEPTANCE_SCHEMA = "dayu.controlled-runtime-acceptance.v1"
...
class ControlledRuntimeAcceptance(BaseModel):
    ...
    schema_version: Literal["dayu.controlled-runtime-acceptance.v1"]
    ...
    compiler_version: Literal["dayu.drtc-compiler.v2"]
...
def controlled_runtime_acceptance() -> ControlledRuntimeAcceptance:
    ...
    if dayu_ids != {"DF01", "DRTC-S01", "G01", "G02", "G03"}:
